...
const FAQ = () => {
  ...
  // Filter sections based on search term (case-insensitive)
  ...
  // Toggle expand/collapse state by question
    ...
    <div className="faq-container">
      <div className="faq-content">
        ...
        <div className="faq-contact">
          ...
          <button
            className="contact-btn see-more-btn"
            style={{
              marginTop: "20px",
              background: "#ad0fd8",
              color: "white",
            ...
            onClick={() =>
              window.open(
                "https://docs.google.com/document/d/1wRznCEG5eJOT8uyfs0Fva2wwu0vN1GpxFskJaQcQtGc/edit?usp=drive_link",
                "_blank"
              )
            }
          >
